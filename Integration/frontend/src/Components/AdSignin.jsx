...
//   return (
//     <div id="bck">
//     <section className={`awrapper ${isSignup ? 'active' : ''}`}>
//       <div className="form asignup">
//         <header id="sh" >Admin Access</header>
//         <form onSubmit={handleSignupSubmit}>
//           <input id="in" type="text" placeholder="Full name" value={fullName} onChange={handleFullNameChange} required />
//           <input id="in" type="text" placeholder="Email address" value={signupEmail} onChange={handleSignupEmailChange} required />
//           {signupEmailError && <span className="error">{signupEmailError}</span>}
//           <input id="in" type="password" placeholder="Password" value={signupPassword} onChange={handleSignupPasswordChange} required />
//           <input id="in" type="text" placeholder="Phone" required />
//           <div className="acheckbox">
//             <input type="checkbox" id="signupCheck" />
//             <label id="ac" htmlFor="signupCheck">I accept all terms & conditions</label>
//           </div>
//           <input type="submit" value="Signup" onClick={switchForm} />
//         </form>
//       </div>
//       <div className="form alogin">
//         <header id="lh" >Login</header>
...
if(userinfo.username=="SKCET" && userinfo.roles=='ADMIN'){
