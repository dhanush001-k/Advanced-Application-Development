  ...
  return (
    <div className="back3">
      ...
      <br />
        ...
        <Box sx={{height: '55vh', width: '80%', backgroundColor: 'teal', padding: '0px',  textAlign: 'center', display: 'flex' ,'&:hover': {
          ...
          <div style={{ flex: 1, marginLeft: '10px' }}>
            ...
            <p id="apply">These types of loans are also known as Retail Agri Loans is a type of loan which allows a farmer to meet his short-term 
              ...
              <br></br>
            <Button variant="contained" color="primary" onClick={() => localStorage.setItem('loanType', 'Crop Loan')} component={NavLink} to="/Applyform">Apply Now</Button>
          </div>
        </Box>
        </center>
        ...
        <br></br>
        <center>
        <Box sx={{height: '55vh', width: '80%', backgroundColor: 'salmon', padding: '0px', textAlign: 'center', display: 'flex','&:hover': {
          transform: 'scale(1.05)', // Scale up the box on hover
            transition: 'transform 0.3s ease', // Add transition effect
          },  }}>
          <div style={{ flex: 1 }}>
          ...
          <div style={{ flex: 1, marginLeft: '10px' }}>
            ...
            <br></br>
            <Button variant="contained" color="primary" onClick={() => localStorage.setItem('loanType', 'Agricultural Loan')} component={NavLink} to="/Applyform">Apply Now</Button>
          </div>
        </Box>
        </center>
        ...
        <br></br>
        <center>
        <Box sx={{height: '55vh', width: '80%', backgroundColor: 'brown', padding: '0px',  textAlign: 'center', display: 'flex' ,'&:hover': {
          transform: 'scale(1.05)', // Scale up the box on hover
          transition: 'transform 0.3s ease', // Add transition effect
        }, }}>
          <div style={{ flex: 1 }}>
          ...
          <div style={{ flex: 1, marginLeft: '10px' }}>
            ...
            <br></br>
            <Button variant="contained" color="primary" onClick={() => localStorage.setItem('loanType', 'Solar Pump Set Loan')} component={NavLink} to="/Applyform">Apply Now</Button>
          </div>
        </Box>
        </center>
        ...
        <br></br>
        <center>
        <Box sx={{height: '55vh', width: '80%', backgroundColor: 'aquamarine', padding: '0px',  textAlign: 'center', display: 'flex' ,'&:hover': {
          transform: 'scale(1.05)', // Scale up the box on hover
          transition: 'transform 0.3s ease', // Add transition effect
        }, }}>
          <div style={{ flex: 1 }}>
          ...
          <div style={{ flex: 1, marginLeft: '10px' }}>
            ...
            <br></br>
            <Button variant="contained" color="primary" onClick={() => localStorage.setItem('loanType', 'Agricultural Gold Loan')} component={NavLink} to="/Applyform">Apply Now</Button>
          </div>
        </Box>
        </center>
        ...
        <br></br>
        <center>
        <Box sx={{height: '55vh', width: '80%', backgroundColor: 'lightgreen', padding: '0px', textAlign: 'center', display: 'flex','&:hover': {
          transform: 'scale(1.05)', // Scale up the box on hover
          transition: 'transform 0.3s ease', // Add transition effect
        },  }}>
          <div style={{ flex: 1 }}>
          ...
          <div style={{ flex: 1, marginLeft: '10px' }}>
            ...
            <br></br>
            <Button variant="contained" color="primary" onClick={() => localStorage.setItem('loanType', 'Horticulture Loan')} component={NavLink} to="/Applyform">Apply Now</Button>
          </div>
        </Box>
        </center>
        ...
        <br></br>
        <center>
        <Box sx={{height: '55vh', width: '80%', backgroundColor: 'grey', padding: '0px', textAlign: 'center', display: 'flex' ,'&:hover': {
          transform: 'scale(1.05)', // Scale up the box on hover
          transition: 'transform 0.3s ease', // Add transition effect
        }, }}>
          <div style={{ flex: 1 }}>
          ...
          <div style={{ flex: 1, marginLeft: '10px' }}>
            ...
            <br></br>
            <Button variant="contained" color="primary" onClick={() => localStorage.setItem('loanType', 'Agricultural Term Loan')} component={NavLink} to="/Applyform">Apply Now</Button>
          </div>
        </Box>
        </center>
